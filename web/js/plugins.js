        ...
        jQuery(this).submit(function(){
            ...
            if (phoneField.length) {
                ...
                if (phone === '' && phoneField.data('required') === 1){
                    ...
                    jQuery('#phone_state').html("Please enter your Phone Number");
                    errors++;
                } else {
                    if (jQuery('#phone_row').hasClass('check_wrong')) {
            ...
            if (messageField.length) {
                ...
                if (message === '' && messageField.data('required') === 1){
                    ...
                    jQuery('#message_state').html("Please enter a Message");
                    errors++;
                } else {
                    if (jQuery('#message_row').hasClass('check_wrong')) {
            ...
            if (errors === 0){
                jQuery.ajax({
                    ...
                    success: function(data){
                        if (data.success){
                            jQuery('.w-form-field-success').html("Thank you! Your message was sent.");
