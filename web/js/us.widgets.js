                        ...
                        if ( ! running) {
                            if (section.hasClass('active')) {
                                ...
                                section_content.slideDown(null, function(){
                                    ...
                                    running = false;
                                    section.find('.w-map-h').each(function(map){
	...
	$.fn.wPortfolio = function () {
		...
		return this.each(function () {
			var portfolio = $(this),
                ...
                detailsLoading = $('<div class="l-portfolio-loading"><div class="w-preloader type_3"><div class="w-preloader-h"></div></div></div>').appendTo(details),
