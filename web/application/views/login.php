                ...
                <div class="one-half">
                    <div class="l-header-h i-cf">
                        ...
                        <div id="formulario">
                            ...
                            $ati1 = array('placeholder' => 'Email', 'name' => 'user', 'id' => 'user');
                    ...
                    <div class="l-header-h i-cf">
                        ...
                        <?php
                        echo form_error('rut');
                        echo form_error('email1');
                        echo form_error('pas1');
                        echo form_label('Ingrese Rut'), "<br/>";
                        echo form_input($ati3), "<br/>";
                        echo form_label('Ingrese Email'), "<br/>";
                        echo form_input(array('placeholder' => 'Email', 'name' => 'email1', 'id' => 'user')), "<br/>";
