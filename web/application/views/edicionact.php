    ...
    <body class="l-body header_sticky one_page_home rounded_corners no_logo">
        ...
        <div class="l-main">
            ...
            //nombre
                                        ...
                                        echo form_input(array('name' => 'nombre1','value'=>$nombre)), "<br/>";
            //fecha
           ...
           */ //lugar                           
                                        ...
                                        echo form_input(array('name' => 'lugar','value'=>$lugar)), "<br/>";
            //responsable                            
                                        echo form_label('<strong>Responsable</strong>'), "<br/>";
                                        echo form_input(array('name' => 'resp','value'=>$resp)), "<br/>";
            //epp                            
                            ...
                            //Casco
                                        ...
                                        echo form_input(array('name' => 'casco', 'style' => 'width: 50px;','value'=>$casco )), "</p>";
                            //Guante
                                        echo '<p>',form_label('Guante','', array('class'=> 'lab1'));
                                        echo form_input(array('name' => 'guante', 'style' => 'width: 50px;','value'=>$guante)), "</p>";
                            //Antiparra
                                        echo '<p>',form_label('Amtiparra','', array('class'=> 'lab1'));
                                        echo form_input(array('name' => 'antiparra', 'style' => 'width: 50px;','value'=>$antiparra)), "</p>";
                            //Mascarilla
                                        echo '<p>',form_label('Mascarilla','', array('class'=> 'lab1'));
                                        echo form_input(array('name' => 'mascarilla', 'style' => 'width: 50px;','value'=>$mascarilla)), "</p>";
                            //Zapatos
                                        echo'<p>', form_label('Zapatos de Seguridad','', array('class'=> 'lab1'));
                                        echo form_input(array('name' => 'zapato', 'style' => 'width: 50px;','value'=>$zapatos)), "</p>";
                            //otros
                                        echo'<p>', form_label('Otros','', array('class'=> 'lab1'));
                                        echo form_input(array('name' => 'otro', 'style' => 'width: 278px; float: none;','value'=>$otro));
                                        echo form_input(array('name' => 'otroc', 'style' => 'width: 50px;','value'=>$otroc)), "</p></ul><br/><br/><br/>";


                                        echo form_label('Riesgos de la zona de trabajo'), '<br/>';
                                        echo form_textarea(array('cols' => '50', 'rows' => '10', 'name' => 'riesgos','value'=>$riesgo)), '<br/><br/>';

                                        echo form_label('Plan de mitigacion de riesgos:'), '<br/>';
                                        echo form_textarea(array('cols' => '50', 'rows' => '10', 'name' => 'mitigacion','value'=>$mitigacion)), '<br/>';
                                        ?>			
                                    </div >
                                    <div class="one-half">
